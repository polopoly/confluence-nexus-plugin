...
/**
 * From https://github.com/apache/maven/blob/master/maven-artifact/src/main/java/org/apache/maven/artifact/versioning/ComparableVersion.java
 *
 * <p>
...
public class ComparableVersion
    ...
    private static class IntItem
        ...
        public int compareTo(Item item) {
            ...
            switch (item.getType()) {
                case INT_ITEM:
                    ...
                    return IntegerCompare(value, itemValue);
                case LONG_ITEM:
        ...
        private int IntegerCompare(final int value, final int itemValue) {
            if (value > itemValue) {
                return 1;
    ...
    private static class LongItem
        ...
        public int compareTo(Item item) {
            ...
            switch (item.getType()) {
                ...
                case LONG_ITEM:
                    ...
                    return LongCompare(value, itemValue);
                case BIGINTEGER_ITEM:
                    return -1;
        ...
        private int LongCompare(final long value, final long itemValue) {
            if (value > itemValue) {
                return 1;
            } else if (value < itemValue) {
                return -1;
